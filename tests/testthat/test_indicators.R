...
test_that("Obvious errors are dealt",{
  expect_error(estimate_indicators("wrong indicator name", data.frame(), progress = FALSE))
  expect_error(estimate_indicators("soil_erosion", data.frame(), progress = FALSE))
  expect_error(estimate_indicators("soil_erosion", c(2,3), progress = FALSE))
})
...
test_that("tree basal area calculation",{
  expect_error(estimate_indicators("live_tree_basal_area", data.frame(id_stand = "stand 1"), progress = FALSE))
...
test_that("tree density calculation",{
  expect_error(estimate_indicators("live_tree_density", data.frame(id_stand = "stand 1"), progress = FALSE))
...
test_that("quadratic mean tree diameter calculation",{
  expect_error(estimate_indicators("quadratic_mean_tree_diameter", data.frame(id_stand = "stand 1"), progress = FALSE))
...
test_that("dominant tree height calculation",{
  expect_error(estimate_indicators("dominant_tree_height", data.frame(id_stand = "stand 1"), progress = FALSE))
...
test_that("mean tree height calculation",{
  expect_error(estimate_indicators("mean_tree_height", data.frame(id_stand = "stand 1"), progress = FALSE))
...
test_that("hart-becking calculation",{
  expect_error(estimate_indicators("hart_becking_index", data.frame(id_stand = "stand 1"), progress = FALSE))
...
test_that("dominant tree diameter calculation",{
  expect_error(estimate_indicators("dominant_tree_diameter", data.frame(id_stand = "stand 1"), progress = FALSE))
...
test_that("live tree volume stock calculation",{
  ...
  expect_error(estimate_indicators("live_tree_volume_stock", data.frame(id_stand = "stand 1"), progress = FALSE))
...
test_that("live tree carbon stock calculation",{
  ...
  testthat::skip_on_cran()
  testthat::skip_if_not_installed("IFNallometry")
  expect_error(estimate_indicators("live_tree_carbon_stock", data.frame(id_stand = "stand 1"), progress = FALSE))
...
test_that("live tree biomass stock calculation",{
  ...
  testthat::skip_on_cran()
  testthat::skip_if_not_installed("IFNallometry")
  expect_error(estimate_indicators("live_tree_biomass_stock", data.frame(id_stand = "stand 1"), progress = FALSE))
...
#   expect_error(estimate_indicators("soil_erosion_01", data.frame(id_stand = "stand 1"), progress = FALSE))
