...
Package **forestindicators** can be installed from GitHub. At present, it requires the previous installation of package [**IFNallometry**](https://emf-creaf.github.io/IFNallometry/index.html) also available in GitHub only:

```{r installation github IFNallometry, eval = FALSE}
remotes::install_github("emf-creaf/IFNallometry")
```

Once installed, you can proceed to the installation of **forestindicators**:
...
+ A number of *vignettes* illustrate how to use the R package to estimate indicators, and how to define new indicators [here](https://emf-creaf.github.io/forestindicators/articles/).
