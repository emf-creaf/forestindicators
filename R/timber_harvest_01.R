...
.timber_harvest_01 <- function(stand_static_input,
  ...
  plant_input = plant_dynamic_input |> dplyr::filter(state == "live")  
  
  ##
  # stand_static_input$Province = 8  # do it in the console!
  plant_input$vol = timber_volume_function(stand_static_input, plant_input)
